...
const platforms: PlatformSeed[] = [
  ...
  },
  {
    ...
    name: "HR Operations Intelligence Platform",
    tagline: "Designing a unified recruiting and HR operations experience",
    summary:
      "A white-label HR operations prototype connecting candidate records, recruiting pipelines, interview scheduling, tasks, and messaging. Includes a meeting-interface concept and a detailed engineering and go-to-market roadmap.",
    category: "White-label HR & recruiting product design",
    displayStatus: "Prototype",
    tags: ["HR tech", "Prototype", "White-label"],
    techStack: [],
    highlights: [
      "6 navigable screens: dashboard, candidate profile, pipeline, schedule, tasks, messages",
      "In-app meeting interface concept (Zoom/Meet/Teams) — design only, not a production integration",
      "Behavioral interview intelligence concept with intended (not validated) guardrails",
      "130+ task roadmap across 16 phases, plus a vendor registry and GTM checklist",
    ],
    liveUrl: "",
    repoUrl: "",
